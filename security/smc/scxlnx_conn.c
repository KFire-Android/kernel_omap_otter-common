		...
		union SCX_COMMAND_MESSAGE *pMessage)
{
	...
	default:
		/*
		 * All other messages are only valid when a device context
		 * exists
		 */
		if (pConn->nState != SCXLNX_CONN_STATE_VALID_DEVICE_CONTEXT)
			nValid = 0;
