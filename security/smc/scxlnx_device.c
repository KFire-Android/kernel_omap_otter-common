...
#ifdef SMC_OMAP4_POWER_MANAGEMENT
	/*
	 * Add the domain notification callback registering (to call save
	 * context) : DomainPowerNotificationCbk
	 */
...
#ifndef SMC_OMAP4_POWER_MANAGEMENT
...
static int SCXLNXDeviceMmap(struct file *file, struct vm_area_struct *vma)
{
	...
	prot = (vma->vm_page_prot) | L_PTE_MT_WRITEBACK | L_PTE_SHARED;
#endif
	dprintk(KERN_INFO
...
#ifndef NDEBUG
	SCXLNXDumpAttributes_CP15((u32 *)vma->vm_start);
#endif
