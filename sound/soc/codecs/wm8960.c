...
static int wm8960_add_widgets(struct snd_soc_codec *codec)
{
	...
	snd_soc_dapm_new_controls(codec->dapm, wm8960_dapm_widgets,
	...
	if (pdata && pdata->capless) {
		snd_soc_dapm_new_controls(codec->dapm, wm8960_dapm_widgets_capless,
					  ARRAY_SIZE(wm8960_dapm_widgets_capless));

		snd_soc_dapm_add_routes(codec->dapm, audio_paths_capless,
					ARRAY_SIZE(audio_paths_capless));
	} else {
		snd_soc_dapm_new_controls(codec->dapm, wm8960_dapm_widgets_out3,
					  ARRAY_SIZE(wm8960_dapm_widgets_out3));

		snd_soc_dapm_add_routes(codec->dapm, audio_paths_out3,
