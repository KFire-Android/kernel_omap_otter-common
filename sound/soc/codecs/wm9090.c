...
static int wm9090_add_controls(struct snd_soc_codec *codec)
{
	...
	snd_soc_dapm_new_controls(codec->dapm, wm9090_dapm_widgets,
	...
	if (wm9090->pdata.lin1_diff) {
		snd_soc_dapm_add_routes(codec->dapm, audio_map_in1_diff,
					ARRAY_SIZE(audio_map_in1_diff));
	} else {
		snd_soc_dapm_add_routes(codec->dapm, audio_map_in1_se,
	...
	if (wm9090->pdata.lin2_diff) {
		snd_soc_dapm_add_routes(codec->dapm, audio_map_in2_diff,
					ARRAY_SIZE(audio_map_in2_diff));
	} else {
		snd_soc_dapm_add_routes(codec->dapm, audio_map_in2_se,
