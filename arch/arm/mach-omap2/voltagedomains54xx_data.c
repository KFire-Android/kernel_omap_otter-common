...
void __init omap54xx_voltagedomains_init(void)
{
	 ...
	 */
#ifdef CONFIG_PM_OPP
	omap5_voltdm_mpu.volt_data = omap443x_vdd_mpu_volt_data;
	omap5_voltdm_mm.volt_data = omap443x_vdd_iva_volt_data;
	omap5_voltdm_core.volt_data = omap443x_vdd_core_volt_data;
#endif
