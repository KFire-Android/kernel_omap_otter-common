...
struct omap_volt_data omap5430_vdd_mpu_volt_data[] = {
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_LOW, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_LOW, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_LOW, 0xf4, 0x0c),
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_NOM, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_NOM, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_NOM, 0xf9, 0x16),
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_HIGH, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_HIGH, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_HIGH, 0xfa, 0x23),
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MPU_OPP_SB, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_SB, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_SB, 0xfa, 0x27),
...
struct omap_volt_data omap5430_vdd_mm_volt_data[] = {
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_LOW, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_LOW, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_LOW, 0xf4, 0x0c),
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_NOM, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_NOM, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_NOM, 0xf9, 0x16),
	OMAP5_VOLT_DATA_DEFINE(OMAP5430_VDD_MM_OPP_OD, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_OD, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_OD, 0xfa, 0x23),
	OMAP5_VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap5432_vdd_mpu_volt_data[] = {
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MPU_OPP_LOW, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_LOW, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_LOW, 0xf4, 0x0c),
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MPU_OPP_NOM, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_NOM, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_NOM, 0xf9, 0x16),
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MPU_OPP_HIGH, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_HIGH, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_HIGH, 0xfa, 0x23),
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MPU_OPP_SB, OMAP54XX_CONTROL_FUSE_MPU_SVT_OPP_SB, OMAP54XX_CONTROL_FUSE_MPU_LVT_OPP_SB, 0xfa, 0x27),
	OMAP5_VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap5432_vdd_mm_volt_data[] = {
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MM_OPP_LOW, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_LOW, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_LOW, 0xf4, 0x0c),
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MM_OPP_NOM, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_NOM, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_NOM, 0xf9, 0x16),
	OMAP5_VOLT_DATA_DEFINE(OMAP5432_VDD_MM_OPP_OD, OMAP54XX_CONTROL_FUSE_MM_SVT_OPP_OD, OMAP54XX_CONTROL_FUSE_MM_LVT_OPP_OD, 0xfa, 0x23),
	OMAP5_VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
