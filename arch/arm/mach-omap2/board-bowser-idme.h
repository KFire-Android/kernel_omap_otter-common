...
enum idme_board_type{
	...
	IDME_BOARD_TYPE_SOHO_PROTO,
	IDME_BOARD_TYPE_SOHO_PreEVT1,
	IDME_BOARD_TYPE_SOHO_EVT1,
	IDME_BOARD_TYPE_SOHO_EVT2,
	IDME_BOARD_TYPE_SOHO_DVT,
	IDME_BOARD_TYPE_SOHO_PVT,
};
